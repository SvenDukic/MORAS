        ...
        if l[0] == "push":
            if len(l) == 3:
                if l[2].isdigit():
                    ...
                    self._flag = False
                    Parser._error("Parser", n, "Expected non-negative number");
                    return ""
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if l[1] in self.labels:
                    return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
                else:
                    self._flag = False
                    Parser._error("Parser", n, "Undefined destination of goto");
                    return ""
                ...
                if l[1] in self.labels:
                    ...
                    self._flag = False
                    Parser._error("Parser", n, "Undefined destination of if-goto");
                    return ""
